...
columns, format the date columns, add a Month column, convert property 
and crop damage columns to USD, and filter to include only data from the
...
# Filter storm data to include only the 50 US states
library(datasets)
stormdata <- stormdata[STATE %in% state.abb]
```
